...
execute if data storage cu:data_storage create_container.result run tellraw @a[tag=cu._tag.listenDebugMessage] ["Created data container, UUID: ",{"nbt":"create_container.result","storage":"cu:data_storage","interpret":false}]
