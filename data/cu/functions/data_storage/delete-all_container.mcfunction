...
tellraw @a[tag=!self,tag=cu._tag.debugView] [{"selector":"@s"}," >>> Deleted ",{"score":{"name":"#result","objective":"cu.dataStorage"}}," data container",{"nbt":"plural.result","storage":"cu:string","interpret":false}]
