...
execute if score #uips +CreativeUtility matches 1 run scoreboard players set @a UIPSCount 0
execute if score #uips +CreativeUtility matches 1 run scoreboard players reset @a UIPS
