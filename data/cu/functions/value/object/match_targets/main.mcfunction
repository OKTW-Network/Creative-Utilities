...
execute unless score #value.object.match_targets.method cu matches -2147483648..2147483647 run scoreboard players set #value.object.match_targets.method cu 0
