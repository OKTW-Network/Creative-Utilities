execute store success score #value.object.match.result cu run data modify storage cu:value object.match.source merge from storage cu:value object.match.input
