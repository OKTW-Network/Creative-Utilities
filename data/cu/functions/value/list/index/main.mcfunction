...
execute unless score #value.list.index.arrange cu matches -2147483648..2147483647 run scoreboard players set #value.list.index.arrange cu 0
execute unless score #value.list.index.circular cu matches -2147483648..2147483647 run scoreboard players set #value.list.index.circular cu 0
