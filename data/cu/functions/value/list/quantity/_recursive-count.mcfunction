data modify storage cu:value different.input1 set from storage cu:value list.quantity.target
data modify storage cu:value different.input2 set from storage cu:value list.quantity.source[0]
