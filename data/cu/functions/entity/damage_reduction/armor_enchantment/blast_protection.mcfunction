data modify storage math:io addition.input append from storage cu:entity damage_reduction._armorItems[].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl
