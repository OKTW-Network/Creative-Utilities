execute store result score #1 temp store result score #2 temp run attribute @s generic.armor get 100
execute store result score #3 temp run attribute @s generic.armor_toughness get 100
