execute unless score #item.simplify.nbt_structure.keepID cu matches 0..1 run scoreboard players set #item.simplify.nbt_structure.keepID cu 1
execute unless score #item.simplify.nbt_structure.keepCount cu matches 0..1 run scoreboard players set #item.simplify.nbt_structure.keepCount cu 1
execute unless score #item.simplify.nbt_structure.keepTag cu matches 0..1 run scoreboard players set #item.simplify.nbt_structure.keepTag cu 1
execute unless score #item.simplify.nbt_structure.keepSlot cu matches 0..1 run scoreboard players set #item.simplify.nbt_structure.keepSlot cu 1
