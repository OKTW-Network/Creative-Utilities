...
execute unless function cu:item/give/_func/validate_input run return run function cu:item/give/_return_fail
# Option.omit_owner
...
execute store result score #item.give.Result cu-io at @s run function cu:item/give/_func/give
