...
execute unless score #item.summon_list.Option.prevent_pickup cu-io matches 0..1 run scoreboard players set #item.summon_list.Option.prevent_pickup cu-io 0
execute unless score #item.summon_list.Option.prevent_despawn cu-io matches 0..1 run scoreboard players set #item.summon_list.Option.prevent_despawn cu-io 0
execute unless score #item.summon_list.Option.invulnerable cu-io matches 0..1 run scoreboard players set #item.summon_list.Option.invulnerable cu-io 0
