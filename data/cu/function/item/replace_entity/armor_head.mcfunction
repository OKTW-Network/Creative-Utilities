...
execute in cu:simulation store result score #item.replace_entity.armor_head.Result cu-io run item replace entity @s armor.head from block 0 1 0 container.0
