...
data modify storage cu:item simulate_container._value[] merge value {id:"minecraft:structure_void",Count:1b,components:{"minecraft:custom_data":{cu:{Type:"dummy",id:"item.simulate_container.invertPlaceholder"}}}}
