execute in cu:simulation run data modify storage cu:item simulate_container._value set from block 0 1 0 Items
...
execute in cu:simulation run data modify block 0 1 0 Items set from storage cu:item simulate_container._value
...
execute in cu:simulation run data modify block 0 1 0 Items prepend from storage cu:item simulate_container._value[]
execute in cu:simulation run data remove block 0 1 0 Items[{components:{"minecraft:custom_data":{cu:{Type:"dummy",id:"item.simulate_container.invertPlaceholder"}}}}]
