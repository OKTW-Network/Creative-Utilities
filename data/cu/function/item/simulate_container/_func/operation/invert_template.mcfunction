...
data modify storage cu:internal dummy[] merge value {id:"minecraft:structure_void",count:1,components:{"minecraft:custom_data":{cu:{Type:"dummy",id:"item.simulate_container.invertPlaceholder"}}}}
...
data remove block ~ ~ ~ Items[{components:{"minecraft:custom_data":{cu:{Type:"dummy",id:"item.simulate_container.invertPlaceholder"}}}}]
