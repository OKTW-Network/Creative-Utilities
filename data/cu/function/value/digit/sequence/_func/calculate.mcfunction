...
scoreboard players remove #value.digit.sequence.recur_countdown cu-internal 1
execute if score #value.digit.sequence.recur_countdown cu-internal matches 1.. run function cu:value/digit/sequence/_func/calculate
