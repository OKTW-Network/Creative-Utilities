...
data modify storage cu:value different.input1 set from storage cu:version broadcast_relation.input_1.t
data modify storage cu:value different.input2 set from storage cu:version broadcast_relation.input_2.t
