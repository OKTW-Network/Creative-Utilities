...
data modify storage cu:io value.different.Input.1 set from storage cu:version broadcast_relation.input_1.t
data modify storage cu:io value.different.Input.2 set from storage cu:version broadcast_relation.input_2.t
function cu:value/different
execute if score #version.broadcast_relation.lock.check_diff cu matches 0 store success score #version.broadcast_relation.lock.check_diff cu if score #value.different.result cu matches 1 unless data storage cu:version broadcast_relation.input_1{t:''} unless data storage cu:version broadcast_relation.input_2{t:''} run scoreboard players set #version.broadcast_relation.result.diff cu 5
