...
execute store result score #1 cu-internal if data storage cu:internal config.register.produce_catalog.product_in_development[-1][]
execute if score #1 cu-internal matches 2.. run data modify storage cu:internal config.register.produce_catalog.product_in_development[-2] append from storage cu:internal config.register.produce_catalog.product_in_development[-1][]
