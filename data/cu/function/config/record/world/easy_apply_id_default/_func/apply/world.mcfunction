execute unless function cu:config/record/world/easy_apply_id_default/_func/get_world_default/main run return fail
execute if score #config.record.Option.force_apply cu-io matches 0 if function cu:config/record/world/_func/check_input_world_id run return 1
