execute store success score #1 cu-internal run function cu:config/record/player/easy_apply_namespace_upstream/_func/apply/process
scoreboard players operation #config.record.player.easy_apply_namespace_upstream.Result cu-io += #1 cu-internal
