...
execute store result storage cu:io data.list.difference.Result[-1].diff int 1 run scoreboard players operation #1 cu-internal += #data.list.difference.input_exist cu-internal
