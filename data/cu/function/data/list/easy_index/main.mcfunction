...
execute store success score #1 cu-internal run function cu:data/list/lazy_index_storage with storage cu:internal dummy
execute if score #1 cu-internal matches 1 run data modify storage cu:io data.list.easy_index.Result set from storage cu:io data.list.lazy_index_storage.Result
