...
execute store success score #1 cu-internal run function cu:data/list/easy_deduplicate/_func/lazy_merge_key with storage cu:internal dummy
execute if score #1 cu-internal matches 1 run data modify storage cu:io data.list.easy_deduplicate.Result append from storage cu:io data.list.easy_deduplicate.Input[0]
