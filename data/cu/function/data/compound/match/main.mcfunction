...
#  1 : Invert the result.
execute if score #value.compound.match.Option.reverse cu-io matches -2147483648..2147483647 run scoreboard players operation #data.compound.match.Option.invert cu-io = #value.compound.match.Option.reverse cu-io
execute if score #value.compound.match.Option.invert cu-io matches -2147483648..2147483647 run scoreboard players operation #data.compound.match.Option.invert cu-io = #value.compound.match.Option.invert cu-io
execute unless score #data.compound.match.Option.invert cu-io matches 0..1 run scoreboard players set #data.compound.match.Option.invert cu-io 0
...
execute if score #data.compound.match.Option.invert cu-io matches 0 run function cu:data/compound/match/_func
