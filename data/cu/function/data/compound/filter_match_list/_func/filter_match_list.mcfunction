...
execute if score #data.compound.filter_match_list.Option.invert cu-io matches 1 run function cu:data/compound/filter_match_list/_func/invert_successful
