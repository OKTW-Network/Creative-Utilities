data remove storage cu:io data.compound.filter_match_list.Input
scoreboard players reset #data.compound.filter_match_list.Option.match_count cu-io
scoreboard players reset #data.compound.filter_match_list.Option.exclude cu-io
scoreboard players reset #data.compound.filter_match_list.Option.invert cu-io
