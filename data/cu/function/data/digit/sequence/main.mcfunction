...
execute unless score #data.digit.sequence.Option.count cu-io matches -2147483648..2147483647 run scoreboard players set #data.digit.sequence.Option.count cu-io 0
# Option.exclude_base
#  0 : Do not apply this option.
