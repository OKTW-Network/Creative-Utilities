...
execute store success score #1 cu-internal summon minecraft:block_display run function cu:data/digit/_func/display_entity/lazy_float_division with storage cu:internal dummy
execute if score #1 cu-internal matches 0 run return run function cu:data/digit/easy_float_multiplication/_return_fail
data modify storage cu:internal dummy set value {dividend:1f,divisor:1f}
