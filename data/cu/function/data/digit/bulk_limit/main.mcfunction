...
execute if score #data.digit.bulk_limit.Option.exclude_max cu-io matches 1 unless score #data.digit.bulk_limit.Option.max cu-io matches -2147483648 run scoreboard players remove #data.digit.bulk_limit.Option.max cu-io 1
