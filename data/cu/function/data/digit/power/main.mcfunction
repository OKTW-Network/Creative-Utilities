...
execute unless score #data.digit.power.Input.exponent cu-io matches -2147483647..2147483647 run return run function cu:data/digit/power/_return_fail
scoreboard players set #1 cu-internal 0
scoreboard players operation #data.digit.power.Option.result_precision cu-io > #1 cu-internal
scoreboard players set #1 cu-internal 9
scoreboard players operation #data.digit.power.Option.result_precision cu-io < #1 cu-internal
...
scoreboard players operation #data.digit.power.recur_countdown cu-internal = #data.digit.power.Input.exponent cu-io
scoreboard players set #1 cu-internal -1
execute if score #data.digit.power.recur_countdown cu-internal matches ..-1 run scoreboard players operation #data.digit.power.recur_countdown cu-internal *= #1 cu-internal
