...
scoreboard players set #1 cu-internal 100
execute store result score #data.digit.percent.Result cu-io run scoreboard players operation #data.digit.percent.Input.base cu-io /= #1 cu-internal
execute if score #data.digit.percent.Option.round cu-io matches 1 run scoreboard players operation #data.digit.percent.round_check cu-internal %= #1 cu-internal
...
return run execute if score #data.digit.percent.Result cu-io matches -2147483648..2147483647 run scoreboard players get #data.digit.percent.Result cu-io
