...
execute store result score #1 cu-internal run data get storage cu:io data.digit.average.Input[0]
data remove storage cu:io data.digit.average.Input[0]
execute store result storage cu:internal dummy int 1 run scoreboard players operation #1 cu-internal /= #data.digit.average.count cu-internal
