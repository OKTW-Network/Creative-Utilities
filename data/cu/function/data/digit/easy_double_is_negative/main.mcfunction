...
execute positioned ~ 0 ~ summon minecraft:marker unless function cu:data/digit/easy_double_is_negative/_func run function cu:data/digit/easy_double_is_negative/_return_fail
