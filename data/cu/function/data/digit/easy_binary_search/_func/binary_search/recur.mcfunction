...
execute store result storage cu:internal dummy.index int 1 store result score #data.digit.easy_binary_search.mid_index cu-internal run scoreboard players operation #1 temp += #data.digit.easy_binary_search.left_index cu-internal
