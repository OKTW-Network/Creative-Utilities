...
execute positioned ~ 0 ~ summon minecraft:marker unless function cu:data/digit/easy_double_addition/_func/marker/main run return run function cu:data/digit/easy_double_addition/_return_fail
