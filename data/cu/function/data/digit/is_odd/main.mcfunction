...
scoreboard players set #1 cu-internal 2
execute store result score #data.digit.is_odd.Result cu-io run scoreboard players operation #data.digit.is_odd.Input cu-io %= #1 cu-internal
