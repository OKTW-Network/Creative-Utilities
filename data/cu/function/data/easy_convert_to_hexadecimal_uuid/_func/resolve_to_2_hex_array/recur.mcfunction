...
data modify storage cu:internal data.easy_convert_to_hexadecimal_uuid.2_hex_array prepend from storage cu:io data.digit.lazy_convert_to_2_digit_hexadecimal.Result
