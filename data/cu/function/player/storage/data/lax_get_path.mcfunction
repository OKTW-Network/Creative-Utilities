...
execute store success score #1 cu-internal run function cu:player/storage/data/lazy_get_uuid_path with storage cu:internal dummy
execute if score #1 cu-internal matches 1 run data modify storage cu:io player.storage.data.lax_get_path.Result set from storage cu:io player.storage.data.lazy_get_uuid_path.Result
