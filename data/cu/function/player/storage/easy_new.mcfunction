...
execute store result score #1 cu-internal run function cu:player/storage/lazy_query_uuid with storage cu:internal dummy
execute if score #1 cu-internal matches 1.. run return fail
