...
scoreboard objectives remove cu-alert
...
data remove storage cu:storage world
data remove storage cu:storage player
...
schedule clear cu:dimension/simulation/primary/busy_setup/main
