...
# execute in cu:simulation positioned 0 9 0 run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["cu.dummy.entity.find_player"],custom_particle:{type:"minecraft:block",block_state:{Name:"minecraft:air"}},Radius:0.0f,WaitTime:2147483647}
summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["cu.dummy.entity.find_player"],custom_particle:{type:"minecraft:block",block_state:{Name:"minecraft:air"}},Radius:0.0f,WaitTime:2147483647}
