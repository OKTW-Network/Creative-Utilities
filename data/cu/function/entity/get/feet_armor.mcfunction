...
execute in cu:simulation run item replace block 0 1 0 container.0 from entity @s armor.feet
execute in cu:simulation run data modify storage cu:entity get.feet_armor.result set from block 0 1 0 Items[{Slot:0b}]
