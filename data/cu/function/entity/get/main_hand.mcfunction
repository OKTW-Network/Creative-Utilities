...
execute in cu:simulation run item replace block 0 1 0 container.0 from entity @s weapon.mainhand
execute in cu:simulation run data modify storage cu:entity get.main_hand.result set from block 0 1 0 Items[{Slot:0b}]
