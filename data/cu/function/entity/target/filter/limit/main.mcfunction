...
execute if score #entity.target.filter.Option.invert cu-io matches 0 run tag @e[tag=!cu-internal.entity.target.filter.limit.1] remove cu-io.entity.target
execute if score #entity.target.filter.Option.invert cu-io matches 1 run tag @e[tag=cu-internal.entity.target.filter.limit.1] remove cu-io.entity.target
