...
execute if score #entity.target.filter.Option.invert cu-io matches 0 store result score #entity.target.filter.lax_limit.Result cu-io run tag @e[tag=!cu-internal.entity.target.filter.lax_limit.1] remove cu-io.entity.target
execute if score #entity.target.filter.Option.invert cu-io matches 1 store result score #entity.target.filter.lax_limit.Result cu-io run tag @e[tag=cu-internal.entity.target.filter.lax_limit.1] remove cu-io.entity.target
