...
execute as @e[type=minecraft:interaction,tag=cu-io.entity.target] if data entity @s attack.player run function cu:entity/target/select/interaction_attack/_func
