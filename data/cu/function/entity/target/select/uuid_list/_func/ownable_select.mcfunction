...
execute on origin store result score #1 cu-internal run tag @s add cu-io.entity.target
scoreboard players operation #entity.target.select.uuid_list.Result cu-io += #1 cu-internal
kill @s
