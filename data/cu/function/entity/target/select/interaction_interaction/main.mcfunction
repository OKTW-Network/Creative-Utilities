...
execute as @e[type=minecraft:interaction,tag=cu-io.entity.target] if data entity @s interaction.player run function cu:entity/target/select/interaction_interaction/_func
