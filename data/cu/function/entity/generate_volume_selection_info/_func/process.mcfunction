...
scoreboard players operation #entity.generate_volume_selection_info.size cu-internal *= #1 cu-internal
scoreboard players operation #entity.generate_volume_selection_info.offset cu-internal *= #1 cu-internal
