...
# execute in cu:data_temp positioned 0 9 0 run summon minecraft:item ~ ~ ~ {Tags:["cu.dummy.entity.find_uuid"],Invulnerable:1b,Age:-32768s,PickupDelay:32767,Item:{id:"minecraft:structure_void",count:1}}
